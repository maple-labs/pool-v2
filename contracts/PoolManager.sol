...
contract PoolManager {
    ...
    Pool public pool;  // TODO: Use IPoolLike
    ...
    function claim(address investment_) external {
        require(pool.totalSupply() != 0, "P:F:ZERO_SUPPLY");
    ...
    function fund(uint256 amountOut_, address investment_, address investmentManager_) external {
        ...
        require(pool.totalSupply() != 0,                 "PM:F:ZERO_SUPPLY");
        ...
        require(ERC20Helper.transferFrom(pool.asset(), address(pool), investment_, amountOut_), "P:F:TRANSFER_FAILED");
